...
const NewContactAirtimeModal = ({ closeModal }) => {
  let org_id = null;
  ...
  const goToAirtimeDispatch = () => {
    closeModal();
    router.push('/apps/airtime/airtime-rewards?tab=Rewards');
  };
...
export default NewContactAirtimeModal;
