...
const VariablesPanel = ({ onVariableAdd }) => {
  ...
  return (
    <div ref={variablesPanelRef} className="fixed top-[24vh] right-20 z-50 flex items-start">
      ...
      {/* Variables Panel */}
      {showVariablesPanel && (
        <div className="absolute right-0 top-0 w-64 bg-white rounded-lg shadow-lg border min-w-[200px] z-20">
          {!showAddVariable ? (
