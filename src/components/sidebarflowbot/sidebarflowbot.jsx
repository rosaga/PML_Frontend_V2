...
const SidebarFlowBot = ({ onClose }) => {
  ...
  return (
    <div className="navbar">
      ...
      {isClient && (<Joyride steps={tourSteps} continuous={true} showProgress={true} showSkipButton={true} run={tourActive} styles={{ options: { primaryColor: "#F58426", }, }} />)}
