...
const SidebarAirtime = () => {
  ...
  const tourSteps = [
    ...
    { target: ".airtime-rewards", content: "Add contacts or contact groups and send data." },
    { target: ".airtime-balance", content: "Top up your account with Data Units or view your Float balance before dispatch." },
    { target: ".contacts", content: "This is the users section. Click to view and manage users" },
    { target: ".settings", content: "Send Customizable Rewards Messages by adding your Sender ID." },
  ];
  ...
  return (
    <>
      ...
      >
        ...
        <div className="px-3 pb-4 pt-2 shrink-0 bg-gray-50 dark:bg-gray-800">
          <div
