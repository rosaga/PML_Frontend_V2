...
export async function groupCreate(formValues) {
  ...
  export async function GetAllGroups(org_id, searchParams) {

    let groupUrl = `${apiUrl.GET_CONTACTS}/${org_id}/group?eq__is_deleted=false&orderby=created_at DESC&page=1&size=1000`;
